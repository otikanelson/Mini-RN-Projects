...
// ----------------------------------------------------
// New nested component for a single card item
// ----------------------------------------------------
...
// ----------------------------------------------------
// Main Deck Content Screen Component
// ----------------------------------------------------
const DeckContentScreen: React.FC = () => {
    ...
    // Load deck content on screen mount
    useEffect(() => {
        const fetchDeck = async () => {
            if (deckId) {
                const loadedDeck = await loadDeckContent(deckId);
                // If the loaded deck is null, create an empty one
                if (!loadedDeck) {
    ...
    // Save the entire deck to storage and navigate back
